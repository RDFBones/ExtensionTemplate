...
23. To add documentation resources, check out the 'main' branch. In the 'doc' directory, there are templates for concept drawings and network graphics that you can use to create drawings describing your ontology extension. Note that these files work best with the [draw.io software](https://www.drawio.com).
