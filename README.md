...
7. In the bash script, change the contents of the annotations in [lines 6 to 14](https://github.com/RDFBones/ExtensionTemplate/blob/f3f344fd9bff62de8fc9a223bfadb57ea79d9a76/Script-Build_OntologyExtension-Robot.sh#L6-L14) to suit your extension. The annotation 'shortname' determines the name of the OWL file the script produces. Several creators or contributors can be specified as arrays. In the output file, each person will have its own statement.
